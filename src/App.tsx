...
const allPages=[
    ...
    {p:6,el:<Page6 onNavigate={go} onSave={saveAsset}/>},
    ...
    {p:19,el:<Page19 onNavigate={go}/>},
    {p:20,el:<Page20 onNavigate={go}/>},
    {p:21,el:<Page21 onNavigate={go}/>},
    {p:22,el:<P22/>},
    {p:23,el:<Page23 onNavigate={go}/>},
  ];
